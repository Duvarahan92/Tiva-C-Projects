...
#define INT_PWM0_2              12          // PWM0 Generator 2
#define INT_QEI0                13          // QEI0
#define INT_ADC0SS0             14          // ADC0 Sequence 0
#define INT_ADC0SS1             15          // ADC0 Sequence 1
#define INT_ADC0SS2             16          // ADC0 Sequence 2
#define INT_ADC0SS3             17          // ADC0 Sequence 3
...
#define INT_USB0                44          // USB
#define INT_PWM0_3              45          // PWM Generator 3
#define INT_UDMA                46          // uDMA Software
...
#define INT_WTIMER0A            94         // 32/64-Bit Timer 0A
#define INT_WTIMER0B            95         // 32/64-Bit Timer 0B
#define INT_WTIMER1A            96         // 32/64-Bit Timer 1A
#define INT_WTIMER1B            97         // 32/64-Bit Timer 1B
#define INT_WTIMER2A            98         // 32/64-Bit Timer 2A
#define INT_WTIMER2B            99         // 32/64-Bit Timer 2B
#define INT_WTIMER3A            100         // 32/64-Bit Timer 3A
#define INT_WTIMER3B            101         // 32/64-Bit Timer 3B
#define INT_WTIMER4A            102         // 32/64-Bit Timer 4A
#define INT_WTIMER4B            103         // 32/64-Bit Timer 4B
#define INT_WTIMER5A            104         // 32/64-Bit Timer 5A
#define INT_WTIMER5B            105         // 32/64-Bit Timer 5B
#define INT_SYSEXC              106         // System Exception (imprecise)
#define INT_PWM1_0              134         // PWM1 Generator 0
#define INT_PWM1_1              135         // PWM1 Generator 1
#define INT_PWM1_2              136         // PWM1 Generator 2
#define INT_PWM1_3              137         // PWM1 Generator 3
